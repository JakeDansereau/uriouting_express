...
app.get('/', function(request, response) {
	...
	response.send('Page accessed.'); 
});

app.get('/public/index', function(request, response){
	//sends some information
	response.send('Index/home page'); 
});
